...
#Rails.application.config.assets.precompile += %w( movies.scss )
#Rails.application.config.assets.precompile += %w( music.scss )
#Rails.application.config.assets.precompile += %w( sports.scss )
